...
#    if not os.path.exists('/home/hector/Desktop/work/SmartDays/pebble_code/server/tests/' + user_code):
#        os.makedirs('/home/hector/Desktop/work/SmartDays/pebble_code/server/tests/' + user_code)
    ...
    # Download
#    base_dir_local = '/home/hector/Desktop/work/SmartDays/pebble_code/server/tests/' + user_code + '/'
...
#    base_dir = '/home/hector/Desktop/work/SmartDays/pebble_code/server/tests/' + user_code + '/'
    ...
    for name in this_names:
        if name.find('mood') >= 0:
            ...
            if os.stat(base_dir + name).st_size == 0:
                ...
                this_mood = pd.read_csv(base_dir + name, sep=',', na_values=['NA'])
                mood_all.append(this_mood)
    return mood_all