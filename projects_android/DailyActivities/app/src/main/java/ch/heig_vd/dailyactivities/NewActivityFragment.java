...
public class NewActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<Task> activities = new ArrayList<>();
        activities.add(new Task("Work"));
        activities.add(new Task("Walk"));
        activities.add(new Task("Coffee"));
        activities.add(new Task("Lunch"));
        // TODO read available activities
        ...
        try {
            ...
            if (message.equals(ActivityBlock.getLengthExceptionString())) {
                ...
                builder.setMessage("Maybe the \"From\" time and the \"To\" time are reversed. Would you like to swap them ?")
                        .setPositiveButton("Yes", dialogClickListener).setIcon(android.R.drawable.ic_delete)
