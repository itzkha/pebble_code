setwd("/home/hector/Desktop/work/SmartDays/pebble_code/R/test_matched_2")
...
plot(timestamp.pebble, pebble$xyz[,1], type="l", col="red", ylim=c(-4000, 4000))#, xlim=c(108000, 114000))
lines(timestamp.pebble, pebble$xyz[,2], col="green")
lines(timestamp.pebble, pebble$xyz[,3], col="blue")
abline(v=108350, xpd=NA)
plot(timestamp.pebble, pebble$xyz[,1], type="l", col="red", ylim=c(-4000, 4000))#, xlim=c(7105000, 7113000))
lines(timestamp.pebble, pebble$xyz[,2], col="green")
lines(timestamp.pebble, pebble$xyz[,3], col="blue")
...
plot(timestamp.phone, phone$xyz[,1], type="l", col="red", ylim=c(-4000, 4000))#, xlim=c(108000, 114000))
lines(timestamp.phone, phone$xyz[,2], col="green")
lines(timestamp.phone, phone$xyz[,3], col="blue")
plot(timestamp.phone, phone$xyz[,1], type="l", col="red", ylim=c(-4000, 4000))#, xlim=c(7105000, 7113000))
lines(timestamp.phone, phone$xyz[,2], col="green")
lines(timestamp.phone, phone$xyz[,3], col="blue")
...
par(oma=c(0,0,0,0), mar=c(3,2,1,1), mfrow=c(2,2))
timestamp.pebble <- as.numeric(sapply(pebble$timestamp, function(x){seq(x, by=40, length.out=25)})) - pebble$timestamp[1]
plot(timestamp.pebble, pebble$xyz[,1], type="l", col="red", ylim=c(-4000, 4000), xlim=c(2000, 7000))
lines(timestamp.pebble, pebble$xyz[,2], col="green")
lines(timestamp.pebble, pebble$xyz[,3], col="blue")
abline(v=3700, xpd=NA)
abline(v=4700, xpd=NA)
plot(timestamp.pebble, pebble$xyz[,1], type="l", col="red", ylim=c(-4000, 4000), xlim=c(3695000, 3700000))
lines(timestamp.pebble, pebble$xyz[,2], col="green")
lines(timestamp.pebble, pebble$xyz[,3], col="blue")
abline(v=3696600, xpd=NA)
abline(v=3697820, xpd=NA)

timestamp.phone <- phone$timestamp - phone$timestamp[1]
plot(timestamp.phone, phone$xyz[,1], type="l", col="red", ylim=c(-4000, 4000), xlim=c(2000, 7000))
lines(timestamp.phone, phone$xyz[,2], col="green")
lines(timestamp.phone, phone$xyz[,3], col="blue")
plot(timestamp.phone, phone$xyz[,1], type="l", col="red", ylim=c(-4000, 4000), xlim=c(3695000, 3700000))
lines(timestamp.phone, phone$xyz[,2], col="green")
lines(timestamp.phone, phone$xyz[,3], col="blue")
