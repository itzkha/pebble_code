setwd("/home/hector/Desktop/work/SmartDays/pebble_code/R/test_synchro_start_0")
...
plot(pebble$timestamp, pebble$x, type="l", col="red", ylim=c(-4000, 4000), xlim=c(0, 10000))
lines(pebble$timestamp, pebble$y, col="green")
lines(pebble$timestamp, pebble$z, col="blue")
abline(v=3350, xpd=NA)
abline(v=3500, xpd=NA)
plot(pebble$timestamp, pebble$x, type="l", col="red", ylim=c(-4000, 4000), xlim=c(1796000, 1806000))
lines(pebble$timestamp, pebble$y, col="green")
lines(pebble$timestamp, pebble$z, col="blue")
abline(v=1796100, xpd=NA)
abline(v=1796600, xpd=NA)

plot(phone$timestamp, phone$x, type="l", col="red", ylim=c(-4000, 4000), xlim=c(0, 10000))
lines(phone$timestamp, phone$y, col="green")
lines(phone$timestamp, phone$z, col="blue")
plot(phone$timestamp, phone$x, type="l", col="red", ylim=c(-4000, 4000), xlim=c(1796000, 1806000))
lines(phone$timestamp, phone$y, col="green")
lines(phone$timestamp, phone$z, col="blue")
...
plot(offsets-min(offsets), type="l")
